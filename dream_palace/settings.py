...
variables (see .env.example). Never commit real secrets.
"""
...
# Frontend applications allowed to communicate with this API.
#
# IMPORTANT:
# The current React application is running on:
# http://localhost:3000
#
# The deployed frontend/API may use:
...
MPESA_CONSUMER_KEY = env(
    "MPESA_CONSUMER_KEY",
    ""
)

MPESA_CONSUMER_SECRET = env(
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL",
    "no-reply@dreampalace.example"
)

ADMIN_NOTIFY_EMAIL = env(
    "ADMIN_NOTIFY_EMAIL",
    ""
)